                ...
                <div class="col-md-4 col-md-offset-4">
                    <div class="panel panel-default b-a-2 no-bg b-gray-dark">
                        ...
                        <div class="panel-body">
                            ...
                            <p class="text-center m-b-3">Expocad, Sign in to your account.</p>
                            <?php echo form_open('login/login' , array('id' => 'loginform'));?>
                            <div class="form-group">
                                <label for="username"></label>
                                <input type="text" class="form-control" id="username" name="username" placeholder="Enter Username..." onMouseOver="checking();">
                                <?php echo form_error('username'); ?>
                            </div>
                            <div class="form-group">
                                <label for="password"></label>
                                <input type="password" class="form-control password" id="password" name="password" placeholder="Enter Password..." onMouseOver="checking();">
...
<!--                             <div class="checkbox">
                    ...
                    <p class="text-gray-light text-center"><strong>Expocad </strong> <span class="text-gray-light">&#xA9; 2016 - 2020. Powered by Hummworks, MY</span></p>
                </div>
            </div>
        </div>
