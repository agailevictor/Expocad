                ...
                <div class="col-lg-12">
                    <div class="col-md-8 sub-navbar-column">
                        ...
                        <ol class="breadcrumb navbar-text navbar-right no-bg">
                            ...
                            <li class="active">List Exhibitor(s)</li>
                        </ol>
                    </div>
                    <div class="col-md-4">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
         <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel">Add New Exhibitor</h4>
        </div>
        <div class="modal-body">
            <div class="row">
                <div class="col-lg-12">
                    <div class="form-horizontal">
                        <?php echo form_open('Staff/add_exhibitor' , array('id' => 'add_exhi'));?>
...
<div class="modal fade" id="myModaledit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog">
        <div class="modal-content">
         <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
            <h4 class="modal-title" id="myModalLabel">Edit Exhibitor Details</h4>
        </div>
        <div class="modal-body">
            <div class="row">
                <div class="col-lg-12">
                    <div class="form-horizontal">
                        <?php echo form_open('Staff/update_exhibitor' , array('id' => 'up_exhi'));?>
                        <div class="form-group">
...
<script>
    $("#idListExhi").addClass("active open");
</script>
<script>
    $(document).ready(function() {
        ...
        $(".modaldelete").click(function(){
            if(confirm("Do you want to delete?"))
            {
                ...
                $.post( "<?php echo base_url(); ?>Staff/delete_exhibitor",{id:id}, function( data ) {
                    location.reload();
                });
            }
        });
