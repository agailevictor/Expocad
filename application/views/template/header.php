...
<head>
    ...
    <!-- Full Calendar : START-->
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/plugins/fullcalendar/fullcalendar.css" type="text/css" />
    <!-- Full Calendar : END-->
    <!-- Highcharts : START-->
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/plugins/Highcharts/css/highcharts.css" type="text/css" />
    <!-- Highcharts : END-->        
    <!-- JQuery-->
